...
export const RPC_WITHOUT_ADVANCED_MODE = "Use --advanced to connect to a eacrd instance manually via PRC";
...
export const DIFF_CONNECTION_ERROR = "daemon and eacrediton does not have the same network";
...
Options
  ...
  --extrawalletargs  Pass extra arguments to eacrwallet.
  --custombinpath    Custom path for eacrd/eacrwallet/dcrctl binaries.
` : null;
