...
There are really only 2 reasons that you should be changing this value:
  ...
  1. If your wallet was created and used heavily prior to roughly v1.0, it may have large address gaps.  If you restore from seed and notice that you are missing funds, you may increase this to 100 (then 1000 if not fixed) then restart eacrediton.  Once your balance is resolved you can revert back to 20.
