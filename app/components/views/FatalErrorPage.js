...
class FatalErrorPage extends React.Component {
  ...
  getErrorAction() {
    ...
    case (daemonError.indexOf(DIFF_CONNECTION_ERROR) !== -1):
      errorMessage = <T id="fatal.suggestion.diffConnection" m="This error typically means you have the testnet flag in your eacrd.conf file. You should check your eacrd.conf file and remove the testnet=1." />;
      break;
