      ...
      <div className="settings-save-button">
        {needNetworkReset ?
          <ResetNetworkButton
            ...
            modalContent={
              <T id="settings.resetNetworkContent" m="The setting you have chosen to change requires Eacrediton to be restarted.  Please confirm this action before proceeding."/>}
